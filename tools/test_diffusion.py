...
from mmseg_custom.apis import multi_gpu_test_multi_steps, single_gpu_test_multi_steps
...
def main():
    ...
    dataset = Subset(dataset, indices=range(0,len(dataset)))
    ...
    if 'PALETTE' in checkpoint.get('meta', {}):
        ...
        model.PALETTE = dataset.dataset.PALETTE
    ...
    if rank == 0:
        ...
        if args.eval:
            ...
            collect_timesteps = model.module.decode_head.collect_timesteps
